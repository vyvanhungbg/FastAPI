...
class Submount(RuleFactory):
    """Like `Subdomain` but prefixes the URL rule with a given string::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            Submount('/deploy', [
                Rule('/', endpoint='deploy/index'),
                Rule('/entry/<entry_slug>', endpoint='deploy/show')
            ])
        ])

    Now the rule ``'deploy/show'`` matches ``/deploy/entry/<entry_slug>``.
    """
...
class EndpointPrefix(RuleFactory):
    ...
    another string. This can be useful for sub applications::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            EndpointPrefix('deploy/', [Submount('/deploy', [
                Rule('/', endpoint='index'),
